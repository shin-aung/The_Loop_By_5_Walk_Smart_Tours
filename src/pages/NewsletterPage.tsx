      ...
      <section className="section section--white">
        <div className="container">
          <div className="grid-2" style={{ alignItems: "flex-start", gap: "3.5rem" }}>
            ...
            <div>
              ...
              >
                ...
                <div style={{
                  ...
                  textTransform: "uppercase", color: "var(--gold-accent)", marginBottom: "1rem",
                }}>
                  Limited Edition · May 2026
                </div>
                <h2 style={{
                  fontFamily: "var(--font-display)", fontSize: "1.75rem",
                  color: "var(--white)", marginBottom: "0.5rem", fontStyle: "italic",
                }}>
                  The Lane Edit
                </h2>
                <p style={{ fontSize: "0.875rem", color: "rgba(255,255,255,0.65)", marginBottom: "2rem" }}>
            ...
            {/* Right: details */}
            <div>
              <SectionTitle eyebrow="Newsletter" heading="May 2026 Limited Edition" />
              <p style={{ color: "var(--text-muted)", lineHeight: 1.75, marginBottom: "1.5rem" }}>
                ...
                spotlighting the Haji Lane "The Lane Edit" walking tour. Across 11 beautifully
                designed pages, the newsletter captures the sights, stories, and cultural
                richness of one of Singapore's most creative streets.
              </p>
              <p style={{ color: "var(--text-muted)", lineHeight: 1.75, marginBottom: "2rem" }}>
                Distributed to all PGDM students at ACETEK College — featuring student
                stories, curated photography, and cultural insights from our Walk Smart
                Free Walking Tours.
              </p>

              <h3 style={{
                fontFamily: "var(--font-display)", fontSize: "1.1rem",
                color: "var(--dark-brown)", marginBottom: "1.25rem",
              }}>
                What's Inside
              </h3>
              <div style={{ display: "flex", flexDirection: "column", gap: "0.875rem", marginBottom: "2rem" }}>
                {[
                  ...
                  { icon: "✍️", title: "Student Stories", desc: "Personal reflections and experiences from the Haji Lane tour by our team members." },
                  { icon: "📸", title: "Curated Photography", desc: "Artistic photos captured during the Walk Smart tour of Haji Lane." },
                  ...
                  <div key={item.title} style={{
                    ...
                    <div>
                      <div style={{ fontWeight: 600, fontSize: "0.9rem", color: "var(--dark-brown)", marginBottom: "0.25rem" }}>
                        {item.title}
                      </div>
              ...
              <div style={{
                padding: "1.25rem", background: "var(--light-beige)",
                borderRadius: "var(--radius-sm)", borderLeft: "3px solid var(--gold-accent)",
              }}>
                <p style={{ fontSize: "0.82rem", color: "var(--text-muted)", lineHeight: 1.6 }}>
                  <strong style={{ color: "var(--dark-brown)" }}>📋 Pages:</strong> 11 pages ·
                  <strong style={{ color: "var(--dark-brown)" }}> Format:</strong> A4 PDF ·
                  <strong style={{ color: "var(--dark-brown)" }}> Author:</strong> Shweta Suryavanshi ·
                  <strong style={{ color: "var(--dark-brown)" }}> Created:</strong> Canva · May 2026
                </p>
              </div>
            </div>
          </div>
